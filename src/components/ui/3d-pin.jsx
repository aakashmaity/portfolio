...
export const PinContainer = ({
  ...
  const [transform, setTransform] = useState("translate(-50%,-50%) rotateX(40deg) scale(0.8)");
...
export const PinPerspective = ({
  ...
  return (
    <motion.div
      className="pointer-events-none  w-96 h-80 flex items-center justify-center opacity-100 group-hover/pin:opacity-0 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        {/* Water deop effect when pin appears */}
        ...
        <>
          <motion.div
            className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-40 group-hover/pin:h-20 blur-[2px]" />
          <motion.div
            className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-40 group-hover/pin:h-20  " />
          <motion.div
